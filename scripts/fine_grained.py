...
from compcars.resnet34 import *
from compcars.custom_dataset import *
from compcars.imbalance_check import *
from compcars.metrics import *
from compcars.dataset_utility import *
from compcars.network_utility import *
...
# Load the dataset
train_dataset_full = MMdataset(image_paths_file='Prog/data/train_test_split/classification/train.txt',
                              root_dir='Prog/data/image',
                              labels_dir='Prog/data/label',
                              transform=data_transforms['train'])

test_dataset = MMdataset(image_paths_file='Prog/data/train_test_split/classification/test.txt',
                             root_dir='Prog/data/image',
                             labels_dir='Prog/data/label',
...
"""Following lines about the creation of augmented dataset must be activated in the case with focal loss
Note that in this case we have to use this new train_dataset_augmented instead of train_dataset_full in the following"""
# Identify classes with the lowest number of samples (function defined in dataset_utility.py)
"""low_sample_classes = get_low_sample_classes(train_dataset_full, threshold=50)

# Create the augmented dataset for training
train_dataset_augmented = MMDatasetWithAugmentation(
...
"""
# Dictionary to store the number of samples per model
model_sample_count = {}
...
"""FineGrainedResnet34 model is defined in 'resnet34.py'"""
...
"""Following line must be activated if you want to use focal loss"""
...
def train(model, train_loader, val_loader, optimizer, make_criterion=None, scheduler=None, epochs=10, device='cuda'):
    ...
    for epoch in range(epochs):
        ...
        for images, make_labels, model_labels in pbar:
            ...
            """Activate the following and deactive the cross_entropy for make to use focal loss"""
